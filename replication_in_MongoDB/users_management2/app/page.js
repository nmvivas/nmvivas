...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      const result = await axios("http://192.168.43.112:3003/users");
  ...
  return (
    <Box sx={{ padding: "35px" }}>
            ...
            <Button
              onClick={async () => {
                const response = await axios.post(
                  "http://192.168.43.112:3003/users/create",
                  newUserForm
                );
                console.log("asdasd");
        ...
        <Box sx={style}>
          ...
          >
            ...
            <Button
              ...
              onClick={async () => {
                const response = await axios.post(
                  "http://192.168.43.112:3003/users/edit",
                  { ...selected }
                );
      ...
      >
        <Typography variant="h3">Reading Users Management</Typography>
      </Box>
